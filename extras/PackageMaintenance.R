...
#
# This file is part of FluDeathValidation
#
...
OhdsiRTools::checkUsagePackage("FluDeathValidation")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/FluDeathValidation.pdf")
shell("R CMD Rd2pdf ./ --output=extras/FluDeathValidation.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "FluDeathValidation")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("FluDeathValidation")
