...
======================
  ...
  Introduction
============
  Prediction of mortality after 30 / 60 / 90 days after influenza infection


Features
========
  - condition / drug history until 30 days prior to the influenza infection

Technology
==========
  FluDeathValidation is an R package.
...
Development
===========
  FluDeathValidation is being developed in R Studio.
